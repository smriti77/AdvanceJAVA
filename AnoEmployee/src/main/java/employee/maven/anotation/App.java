...
public class App {
    ...
    public static void main(String[] args) {
        ...
        try {
        	...
        	public class Show servlet components servlet
        	 public void service servlet request req servlet response resp
        	 
        	 int id = Integer parseInt req.getparameter("id");
        	try session session = hibernateUtil.getsessipnfactory()
            while (true) {
